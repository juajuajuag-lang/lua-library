...
local function SaveLighting()
    ...
    if LightingOriginal.Brightness==nil then
        LightingOriginal.Brightness=
            Lighting.Brightness
    end

    if LightingOriginal.ClockTime==nil then
        LightingOriginal.ClockTime=
            Lighting.ClockTime
    end

    if LightingOriginal.FogStart==nil then
        LightingOriginal.FogStart=
            Lighting.FogStart
    end

    if LightingOriginal.FogEnd==nil then
        LightingOriginal.FogEnd=
            Lighting.FogEnd
    end

    if LightingOriginal.GlobalShadows==nil then
...
print("[KysHub] Lighting V1 loaded")
